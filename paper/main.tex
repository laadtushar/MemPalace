...
%% Rights / metadata (non-ACM preprint)
\setcopyright{none}
...
\begin{lstlisting}[language=Rust,caption={The SourceAdapter trait.},label={lst:source-adapter}]
...
\begin{lstlisting}[language=Rust,caption={LLM port interfaces.},label={lst:llm-ports}]
#[async_trait]
...
The analysis pipeline transforms raw personal documents into structured insights through eight sequential stages, orchestrated by a central \texttt{run\_analysis} function that coordinates all stages and aggregates results.
...
Our algorithm uses a two-phase approach:
...
The narrative generator produced a 400-word synthesis describing the participant's career philosophy evolution, noting the transition from a risk-averse to a growth-oriented mindset, correlated with a period of increased writing about entrepreneurship and creativity in their Obsidian notes.
...
\newblock Microsoft Windows Blog, May 2024.
\newblock \url{https://blogs.windows.com/windowsexperience/2024/05/20/recall/}.
...
Cunchao Jiang, Jianghong Ma, and Xiao~Qin.
\newblock A Survey on Temporal Knowledge Graph: Representation, Completion, and Applications.
...
Prateek Chhikara, Dev Khant, Saket Arora, Taranjeet Singh, and Deshraj Yadav.
...
\newblock MemoRAG: Moving Towards Next-Gen RAG Via Memory-Inspired Knowledge Discovery.
\newblock {\em arXiv preprint arXiv:2409.05591}, 2024.

\bibitem{yang2025nemori}
Jingru Yang, Yutong He, Wenqi Zhang, Yiwen Guo, Hao Chen, and Tao Gui.
\newblock NEMORI: Towards Self-Organizing Agent Memory via Structured Entity-Relation Networks.
\newblock {\em arXiv preprint arXiv:2508.03341}, 2025.

\bibitem{zhang2024hindsight}
Dayoon Zhang, Ajay Patel, and Aditya Grover.
\newblock Hindsight: A Framework for Agent Memory with Opinion Networks.
\newblock {\em arXiv preprint arXiv:2512.12818}, 2024.

\bibitem{nair2025episodic}
Rishikesh Nair, Zijian Zhang, and Xiao~Liu.
\newblock Episodic Memory for Retrieval-Augmented Generation.
